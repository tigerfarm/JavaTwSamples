...
public class jSignatureValidationPost {
    ...
    public static void main(String[] args) {
        ...
        String requestString = "ToCountry=US&ToState=CA&SmsMessageSid=SM60566ee207e123ee2765abcc55c9b9c9&NumMedia=0&ToCity=SAN+BRUNO&FromZip=94030&SmsSid=SM60566ee207e123ee2765abcc55c9b9c9&FromState=CA&SmsStatus=received&FromCity=SAN+BRUNO&Body=hi+there%2C+2%2B3%3D4&FromCountry=US&To=%2B16505552222&ToZip=94030&NumSegments=1&ReferralNumMedia=0&MessageSid=SM60566ee207e123ee2765abcc55c9b9c9&AccountSid=ACa48237447837494873949a3&From=%2B16505551111&ApiVersion=2010-04-01";
        ...
        for (String part : parts) {
            ...
            // For debugging, can generate params code, that can be used in: jSignatureValidationPostList.java
            // params.put("ApiVersion", "2010-04-01");
            // System.out.println("params.put(\"" + keyVal[0] + "\", \"" + URLDecoder.decode(keyVal[1]) + "\");" + "  // " + keyVal[1]);
        }
