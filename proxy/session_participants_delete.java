...
public class session_participants_delete {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("+ Delete session participants for Proxy service: " + serviceSid);
        ...
        for (Participant itemParticipant : Participants) {
            Participant.deleter(serviceSid, sessionSid, itemParticipant.getSid()).delete();
            System.out.println(
                    "++ Deleted: " + itemParticipant.getSid() + ", " + itemParticipant.getFriendlyName() + ", " + itemParticipant.getProxyIdentifier()
            );
        }
    }
}
