/*
 * Author: Stacy David
 * Program uses a simple type of Turing machine approach to parsing,
 *    by moving a pointer through the characters and checking for key characters.
 */
...
public class PrintJson {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jsonRequest;
        jsonRequest = "+ Response: {\"afield\": \"avalue\"}";
